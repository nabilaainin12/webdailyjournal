...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-sm bg-body-tertiary sticky-top">
    <div class="container">
      <a class="navbar-brand" href="#">Nbylla.Skincare</a>
      <button
  ...
  <section id="hero" class="text-center p-5 bg-danger-subtle text-sm-start">
    <div class="container">
      <div class="d-sm-flex flex-sm-row-reverse align-items-center">
        <img src="produk/banner.jpg" class="img-fluid" width="300" />
        <div>
...
<!-- article end -->
      ...
      <div id="carouselExample" class="carousel slide">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="produk/1.jpg" class="d-block w-100" width="100" height="auto">
          </div>
          <div class="carousel-item">
            <img src="produk/2.jpg" class="d-block w-100"  width="100" height="auto">
          </div>
          <div class="carousel-item">
            <img src="produk/3.jpg" class="d-block w-100"  width="100" height="auto">
          </div>
          <div class="carousel-item">
            <img src="produk/4.jpg" class="d-block w-100"  width="100" height="auto">
          </div>
          <div class="carousel-item">
            <img src="produk/5.jpg" class="d-block w-100"  width="100" height="auto">
          </div>
        </div>
        <button
 ...
 <footer id="footer" class="text-center p-5">
  <div>
    <a href="https://www.instagram.com/nbylla.ai"
      ><i class="bi bi-instagram h2 p-2"></i
    ></a>
    <a href="https://twitter.com/Nabilaainin"
      ><i class="bi bi-twitter h2 p-2"></i
    ></a>
    <a href="https://wa.me/+6283829596003"
      ><i class="bi bi-whatsapp h2 p-2"></i
    ></a>
  </div>
  <div>Nabila Ainindita &copy; 2024</div>
</footer>
<!-- footer end -->
